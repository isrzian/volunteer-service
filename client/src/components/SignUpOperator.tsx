...
interface SignUpOperatorProps extends React.HTMLAttributes<HTMLDivElement> {}

const operatorFormSchema = z.object({
  name: z.string({
    required_error: "Укажите отображаемое имя оператора",
  }),
  position: z.string({
    required_error: "Укажите должность оператора",
  }),
  isActive: z.boolean().default(false),
});
type OperatorFormValues = z.infer<typeof operatorFormSchema>;

export function SignUpOperator({ className, ...props }: SignUpOperatorProps) {
