...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-800",
  {
    variants: {
      variant: {
        default:
          "bg-brand-primary text-white hover:bg-brand-primary/90 dark:bg-brand-dark dark:hover:bg-brand-light",
        destructive:
        ...
        secondary:
          "bg-neutral-100 text-neutral-900 hover:bg-neutral-200/80 dark:bg-neutral-700 dark:text-neutral-50 dark:hover:bg-neutral-800/80 border border-neutral-300 dark:border-neutral-500",
        ghost:
